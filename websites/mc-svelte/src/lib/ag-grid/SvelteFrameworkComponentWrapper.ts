import { BaseComponentWrapper, VanillaFrameworkOverrides, type FrameworkComponentWrapper, type IComponent, type WrappableInterface } from 'ag-grid-community';
...
export class SvelteFrameworkComponentWrapper extends BaseComponentWrapper<WrappableInterface> implements FrameworkComponentWrapper {
...
export class SvelteFrameworkOverrides extends VanillaFrameworkOverrides {
  isFrameworkComponent(comp: any): boolean {
    ...
    return comp?.prototype?.constructor?.name?.startsWith('Proxy<') || Object.prototype.isPrototypeOf.call(SvelteComponent, comp);
  }
}
