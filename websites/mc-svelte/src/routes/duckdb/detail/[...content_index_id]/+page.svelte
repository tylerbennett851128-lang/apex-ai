<script lang="ts">
  ...
  import { DuckDbFileDetailQueryService, LogDetailQueryService } from '$mc/duckdb/duckdb-file-query.service';
  ...
  if (lastSection) {
    fileDetailQueryService = new DuckDbFileDetailQueryService(content_index_id, lastSection.atomic_key, lastSection.atomic_type);
