...
1. npm install
2. set all env variables in the Dockerfile into your machine
3. Make sure you have a firebase account setup for test38051 firebase project
4. npm run dev
5. Sign in with Google using your Liquid analytics email
